...
@section('title', 'Update Oceania News')

@section('content')

 <h2> Update Oceania News </h2>
 

<form class="form-horizontal" action="{{url('Ocupdate', [$data->id])}}"  method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
