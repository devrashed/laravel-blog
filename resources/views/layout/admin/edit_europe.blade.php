...
@section('title', 'Update Europe News')

@section('content')

 <h2> Update Europe News </h2>
 

<form class="form-horizontal" action="{{url('Europupdate', [$data->id])}}"  method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
 ...
 <table width="100%">
  ...
  <div class="form-group">
   ...
   <tr>
     ...
     <input class="form-control" type="hidden" name="media" value="Europe">
     </td> 
   </tr>
