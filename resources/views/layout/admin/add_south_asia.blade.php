...
@section('title', 'Add South Asia News')

@section('content')

 <h2> Add South Asia News </h2>
 

<form class="form-horizontal" action="{{URL::to('/insertsouth')}}"  method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
 ...
 <table width="100%">
  ...
  <div class="form-group">
   ...
   <tr>
     <td> <b>Youtube Embad :</b> <input class="form-control" type="text" name="youtube">
